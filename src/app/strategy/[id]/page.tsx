    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800 mb-6">
          ...
          <div className="text-sm text-gray-500">{strategy.whitepaperAuthor}, {strategy.whitepaperYear}</div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
            ...
            <div className="text-sm text-gray-500">/ {simulation?.tradesLimit || 200} limit</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div>
                <h3 className="text-sm font-medium text-gray-400 mb-2">Entry Conditions</h3>
                <ul className="space-y-2">
                  {entryConditions.indicators.map((ind, i) => (
                    <li key={i} className="text-sm bg-gray-800/50 rounded px-3 py-2">
                      {ind.type}: {JSON.stringify(ind).replace(/"type":"[^"]+",?/, '').replace(/[{}]/g, '')}
                    </li>
                  ))}
                  <li className="text-sm bg-gray-800/50 rounded px-3 py-2">
                    Price Range: ${entryConditions.priceRange.min} - ${entryConditions.priceRange.max}
                  </li>
                </ul>
              </div>
              <div>
                <h3 className="text-sm font-medium text-gray-400 mb-2">Exit Conditions</h3>
                <ul className="space-y-2">
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
            ...
            <div className="overflow-x-auto">
              {positions.length > 0 ? (
                ...
                <div className="p-6 text-center text-gray-500">No active positions</div>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
          ...
          <div className="overflow-x-auto">
            {trades.length > 0 ? (
              ...
              <div className="p-6 text-center text-gray-500">No trades yet</div>
            )}
          </div>
        </div>
      </main>
